    ...
    <form method="post" action="#" id="step_1_form">
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="textinput wide" id="step_1_url" name="url" value="http://" />
                </td>
            </tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="bbottom">
                ...
                <td>
                    ...
                    <div id="step_2_url_container" style="display:none;"><input id="step_2_url" type="text" class="textinput wide" name="url" value="" /></div>
                </td>
            </tr>
            ...
            <tr class="bbottom">
                ...
                <td>
                    <div id="step_2_feed_text" class="url"></div>
                    <div id="step_2_feed_container" style="display:none;"><input id="step_2_feed" type="text" class="textinput wide" name="feed" value="" /></div>
                </td>
            </tr>
...
<div class="edit_blog" id="step_3_main" style="display:none">
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr class="bbottom">
            ...
            <td>
                <div id="step_3_feed" class="url" class="url"></div>
            </td>
        </tr>
...
var AddForm = {
    ...
    MAX_CATEGORIES: <?php echo BLOG_MAX_CATEGORIES; ?>,

    categories: <?php echo json_encode(Blog::getCategories());?>,
    ...
    waitStep2: function(){
        ...
        this.domCache.step2.edit.disabled = true;
        this.domCache.step2.title.addClassName("wait");
    },
    ...
    readyStep2: function(){
        ...
        this.domCache.step2.edit.disabled = false;
        this.domCache.step2.title.removeClassName("wait");
        this.validateStep2();
    },
